...
<template>
  <section class="space-y-4">
    <div class="flex items-center gap-2">
      <UIcon name="i-lucide-chart-column-big" class="size-5 text-primary-500" />
      <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">贡献概览</h3>
    </div>

    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <UCard v-for="stat in stats" :key="stat.label" class="!ring-0 shadow-sm dark:shadow-md bg-white dark:bg-gray-900 rounded-xl">
        <div class="space-y-1">
