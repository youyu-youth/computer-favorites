        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div 
              ...
              :class="setting.theme === 'light' ? 'border-emerald-600 bg-emerald-50 dark:bg-emerald-900/20 dark:border-white' : 'border-slate-200 hover:border-slate-300 dark:border-white/10 dark:bg-white/5 dark:hover:border-white/20'"
            >
              <div class="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-full bg-amber-100 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400">
            ...
            <div 
              ...
              class="relative cursor-pointer rounded-xl border-2 p-4 text-center transition-all"
              :class="setting.theme === 'dark' ? 'border-emerald-600 bg-emerald-50 dark:bg-white/10 dark:border-white' : 'border-slate-200 hover:border-slate-300 dark:border-white/10 dark:bg-white/5 dark:hover:border-white/20'"
            >
            ...
            <div 
              ...
              class="relative cursor-pointer rounded-xl border-2 p-4 text-center transition-all"
              :class="setting.theme === 'system' ? 'border-emerald-600 bg-emerald-50 dark:bg-emerald-900/20 dark:border-white' : 'border-slate-200 hover:border-slate-300 dark:border-white/10 dark:bg-white/5 dark:hover:border-white/20'"
            >
              <div class="mx-auto mb-2 flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
