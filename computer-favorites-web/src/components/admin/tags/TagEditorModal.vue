...
const dialogPt = {
  ...
  root: {
    class: 'w-[min(94vw,520px)] rounded-none border border-gray-200 dark:border-dark-border bg-white dark:bg-dark-card shadow-[0_16px_36px_rgba(15,23,42,0.28)] dark:shadow-[0_22px_44px_rgba(2,6,23,0.62)] overflow-visible',
  },
  header: {
...
const colorPickerPt = {
  ...
  preview: {
    class: 'h-10 w-full rounded-none border border-gray-300 bg-transparent dark:border-dark-border focus:outline-none focus:ring-2 focus:ring-[#e95322]/40 cursor-pointer',
  },
  panel: {
    class: 'absolute left-0 top-full z-[80] mt-2 h-[166px] w-[193px] rounded-none border border-gray-200 bg-white shadow-[0_14px_28px_rgba(15,23,42,0.2)] dark:border-dark-border dark:bg-dark-card dark:shadow-[0_18px_36px_rgba(2,6,23,0.52)]',
  },
  content: {
    class: 'relative h-[166px] w-[193px]',
  },
  colorSelector: {
    class: 'absolute left-2 top-2 h-[150px] w-[150px] cursor-crosshair overflow-hidden rounded-none border border-gray-200 dark:border-dark-border',
  },
  colorBackground: {
    class: 'h-full w-full',
  },
  colorHandle: {
    class: 'absolute h-3 w-3 -translate-x-1/2 -translate-y-1/2 rounded-none border border-white shadow',
  },
  hue: {
    class: 'absolute left-[167px] top-2 h-[150px] w-[17px] cursor-row-resize rounded-none border border-gray-200 bg-[linear-gradient(0deg,red_0,#ff0_17%,#0f0_33%,#0ff_50%,#00f_67%,#f0f_83%,red)] dark:border-dark-border',
  },
  hueHandle: {
    class: 'absolute left-0 top-[150px] ml-[-2px] mt-[-5px] h-[10px] w-[21px] rounded-none border-2 border-white bg-black/30 shadow',
  },
} as const
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
          当前颜色：<span class="font-semibold text-gray-700 dark:text-gray-200">{{ modelValue.color }}</span>
        </p>
