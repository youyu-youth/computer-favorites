...
class UserProfileServiceImplTest {
    ...
    void shouldQueryCurrentProfileWithoutUserSettingDeletedCondition() {
        ...
        userProfile.setTechStack("1,2,Java");
        ...
        TechStack springBoot = new TechStack();
        springBoot.setId(1L);
        springBoot.setName("Spring Boot");
        springBoot.setStatus(1);
        springBoot.setDeleted(0);

        TechStack mysql = new TechStack();
        mysql.setId(2L);
        mysql.setName("MySQL");
        mysql.setStatus(1);
        mysql.setDeleted(0);
        ...
        when(techStackMapper.selectList(any())).thenReturn(List.of(springBoot, mysql));
        ...
        try (MockedStatic<StpUtil> stpUtilMock = org.mockito.Mockito.mockStatic(StpUtil.class)) {
            ...
            assertThat(resultVO.getProfile().getTechStack()).isEqualTo("Spring Boot,MySQL,Java");
